...
export default function AddTaskBox({ onAddTaskName }) {
    ...
    // function keyDown(e){
    //     console.log("disparou evanto keyDown",e)
    //     if(e.code == "Enter"){
    //         addTask()
    //     }
    // }
        ...
        <>
            <div className="border border-black p-2 rounded m-2 md:w-120">
                ...
                <div className="flex items-center gap-2 my-2">
                    ...
                    <input type="text" value={taskName} onKeyDown={(e) => {if(e.code == "Enter") {addTask()}}} onChange={(e) => { setTaskName(e.target.value) }} className="border border-black p-1 w-45" />
